                    ...
                    >
                        ...
                        <div className="flex justify-end gap-3 mt-6">
                            ...
                            <button
                                ...
                                disabled={submitting}
                                className="px-5 py-2 rounded-full bg-red-500 text-white text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed hover:brightness-110 transition"
                            >
